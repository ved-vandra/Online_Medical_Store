            ...
            <div class="text-center mb-4">
                ...
                <div class="text-right mr-5">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('categoryproducts',$cid) }}#products" class="dropdown-item">All</a>
                        <a href="{{ route('catestock',[$cid,"stock"=>'in']) }}" class="dropdown-item">in stock</a>
                        <a href="{{ route('catestock',[$cid,"stock"=>'out']) }} " class="dropdown-item">out of stock</a>
                    </div>
                </div>
            </div>
            <div class="row px-xl-5 pb-3">
                        ...
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-body border-left border-right p-0 pt-4 pb-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    <h6> @if ($prod->salestartdate)
                                        <del>{{$prod->price}}₹</del> {{ $prod->saleprice }}₹
                                    @else
                                        {{ $prod->price }}₹
                                    @endif </h6>
                                </div>
